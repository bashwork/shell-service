...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Contact.relation'
        db.alter_column('api_contact', 'relation', self.gf('django.db.models.fields.CharField')(max_length=1))


    def backwards(self, orm):
        
        # Changing field 'Contact.relation'
        db.alter_column('api_contact', 'relation', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))
