...
# Piston imports
from shell.apps.piston.managers import TokenManager, ConsumerManager, ResourceManager
from shell.apps.piston.signals import consumer_post_save, consumer_post_delete
