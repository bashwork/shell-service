...
ADMINS = (
     ('Galen Collins', 'bashwork@gmail.com'),
)
...
DATABASES = {
    'default': {
        ...
        'NAME': 'db/players',            # Or path to database file if using sqlite3.
...
SECRET_KEY = '9$c09ht3-z#hz$58@gt=pt8qk!etz+^65rbv^d(40vbzw(1r4_'
